...
namespace MCForge.Utils {
    ...
    public class FileUtils {
        ...
        public static void CreateFileIfNotExist(string fileLoc) {
        	CreateFileIfNotExist(fileLoc, null);
        }
        /// <summary>
        /// Creats a file if it doesnt already exist, logs results.
        /// </summary>
        /// <param name="fileLoc"></param>
        public static void CreateFileIfNotExist(string fileLoc, string contents) {
