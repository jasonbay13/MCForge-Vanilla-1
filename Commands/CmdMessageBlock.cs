...
namespace MCForge.Commands
{
    public class CmdMessageBlock : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (cpos.message.Contains("/ban") || cpos.message.Contains("/banip") || cpos.message.Contains("/blockset") || cpos.message.Contains("/clearblockchanges") || cpos.message.Contains("/cmdset") || cpos.message.Contains("/deletelvl") || cpos.message.Contains("/deltemprank") || cpos.message.Contains("/demote") || cpos.message.Contains("/explode") || cpos.message.Contains("/freeze") || cpos.message.Contains("/hacks") || cpos.message.Contains("/crashserver") || cpos.message.Contains("/jail") || cpos.message.Contains("/joker") || cpos.message.Contains("/kick") || cpos.message.Contains("/kickall") || cpos.message.Contains("/kickban") || cpos.message.Contains("/limit") || cpos.message.Contains("/moderate") || cpos.message.Contains("/moveall") || cpos.message.Contains("/mute") || cpos.message.Contains("/newlvl") || cpos.message.Contains("/ozone") || cpos.message.Contains("/perbuild") || cpos.message.Contains("/pervisit") || cpos.message.Contains("/promote") || cpos.message.Contains("/renamelvl") || cpos.message.Contains("/restart") || cpos.message.Contains("/restore") || cpos.message.Contains("/") || cpos.message.Contains("/setrank") || cpos.message.Contains("/shutdown") || cpos.message.Contains("/tempban") || cpos.message.Contains("/temprank") || cpos.message.Contains("/uban") || cpos.message.Contains("/unban") || cpos.message.Contains("/unbanip") || cpos.message.Contains("/warn") || cpos.message.Contains("/xban") || cpos.message.Contains("/xmute") || cpos.message.Contains("/zone"))
            {
