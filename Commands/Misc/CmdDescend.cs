...
{
    public class CmdDescend : ICommand
    {
        public string Name { get { return "Descend"; } }
        ...
        {
            p.SendMessage("/descend - Teleports you to the first free space below you");
        }

        public void Initialize()
        {
            Command.AddReference(this, "descend");
        }
    }
}