...
namespace MCForge.Commands.Building {
    public class CmdBall :ICommand {
        ...
        public void Help(Player p) {
            p.SendMessage("/ball - uses radius 10 and type fill");
            p.SendMessage("/ball [radius] - uses given radius and type fill");
            p.SendMessage("/ball [type] - uses radius 10 and given type");
            p.SendMessage("/ball [radius] [type] - uses given radius and given type");
            p.SendMessage("Creates a ball");
